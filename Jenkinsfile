pipeline {
  ...
  environment {
    ...
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'rn:aws:iam::260913995125:role/AMI-Search-testnew12'
       ...
       stage('Upload to AWS') {
         steps {
           ...
           sh 'echo "Uploading content with AWS creds"'
                s3Upload(pathStyleAccessEnabled: true, payloadSigningEnabled: true, file:'lambda_function_new.zip', bucket:'us-east-22222222')
           }  
         }
       }
